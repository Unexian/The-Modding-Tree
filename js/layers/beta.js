addLayer("beta", {
    ...
    tabFormat: [
        ...
        ["display-text", function () {
            return "You have " + format(player[this.layer].power) + " beta power, equating to a " + format(player[this.layer].power.div(5)) + "x multipliter to alpha power effect."
        }],
        "blank",
    ...
    baseAmount() {return player.alpha.power}, // Get the current amount of baseResource
    ...
    upgrades: {
        11: {
            title: "Betatic",
            description: "Multiply beta power base by 1.1.",
            cost: new Decimal(10)
        },
        12: {
            title: "Primary boost",
